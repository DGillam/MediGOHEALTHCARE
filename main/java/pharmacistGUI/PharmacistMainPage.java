 ...
 * @author 20175707
 */
public class PharmacistMainPage extends javax.swing.JFrame {
     ...
     */
    public PharmacistMainPage(Pharmacist pharmacist) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PharmacistMainPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PharmacistMainPage().setVisible(true);
            }
        });
    }

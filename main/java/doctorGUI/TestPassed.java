 ...
 * @author 20175707
 */
public class TestPassed extends javax.swing.JFrame {

    DoctorAddPatient patientData;
    ImageIcon img;
    /**
     * Creates new form TestPassed
     */
    public TestPassed() {
        
    }

    public TestPassed(DoctorAddPatient patientData) {
        img = new ImageIcon(getClass().getResource("/MediGO round symbol.png"));
        this.patientData = patientData;
        initComponents();
        jLabel1.setText("Did " + patientData.firstName + " " +patientData.lastName + " pass the independece test?");
    }
    ...
    private void initComponents() {
        ...
        no.setBackground(new java.awt.Color(42, 81, 197));
        ...
        yes.setBackground(new java.awt.Color(42, 81, 197));
        ...
        jLabel1.setText("Did pass the independece test?");

        check1.setBackground(new java.awt.Color(42, 81, 197));
        check1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        check1.setForeground(new java.awt.Color(255, 255, 255));
        check1.setText("Cancel");
    ...
    private void noActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_noActionPerformed
        ...
        new ExistingCaretaker(patientData, this).setVisible(true);
    }//GEN-LAST:event_noActionPerformed

    private void yesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yesActionPerformed
        new EmailPassword(patientData, this).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestPassed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestPassed().setVisible(true);
            }
        });
    }
